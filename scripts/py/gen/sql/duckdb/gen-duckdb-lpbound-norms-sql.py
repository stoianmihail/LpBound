...
def main(lpbound_config):
  import duckdb
  db_path = os.path.join('dbs', f'{LpBoundPaths.WORKLOAD_TO_DB_MAP[config.benchmark_name]}.duckdb')
...
if __name__ == '__main__':
  ...
  parser.add_argument('benchmark_name', type=str, help='The benchmark to build Lpbound for.')
  parser.add_argument(
    '--p-max',
    type=int,
